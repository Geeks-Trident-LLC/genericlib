        ...
        [
            (
                ...
                dedent(r"""
                    ...
                    ################################################################################
                    Value v11 (\S*[a-zA-Z0-9]\S*( \S*[a-zA-Z0-9]\S*)*)
                    Value v21 (\S*[a-zA-Z0-9]\S*( \S*[a-zA-Z0-9]\S*)*)
        ...
        [
            ...
            (
                ...
                dedent(r"""
                    ...
                    # Created date: YYYY-mm-dd
                    ################################################################################
                    Value time (\S*[a-zA-Z0-9]\S*( \S*[a-zA-Z0-9]\S*)*)
            ...
            (
                ...
                dedent(r"""
                    ...
                    ################################################################################
                    Value time (\S*[a-zA-Z0-9]\S*( \S*[a-zA-Z0-9]\S*)*)
                    Value ipv6 (\S*[a-zA-Z0-9]\S*( \S*[a-zA-Z0-9]\S*)*)
                    Value mac_addr (\S*[a-zA-Z0-9]\S*)
