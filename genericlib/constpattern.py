...
class PATTERN:
    ...
    SYMBOLS_OR_FLEX_GROUP = '%s( +%s)*' % (SYMBOLS, SYMBOLS)
    SYMBOLS_FLEX_GROUP = '%s( +%s)+' % (SYMBOLS, SYMBOLS)
    ...
    NON_WHITESPACES_OR_FLEX_GROUP = r'%s( +%s)*' % (NON_WHITESPACES, NON_WHITESPACES)
