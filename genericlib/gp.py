...
class TranslatedDigitsPattern(TranslatedPattern):
    ...
    def recommend(self, other):
        ...
        is_new_pat_case1 = other.is_letter() or other.is_letters() or other.is_alphabet_numeric()
...
class TranslatedNumberPattern(TranslatedPattern):
    ...
    def recommend(self, other):
        ...
        is_new_pat_case1 |= other.is_symbol() or other.is_symbols() or other.is_word()
